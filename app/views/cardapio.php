...
<body>
    ...
    <div class="container">
        ...
        <?php
        $acaoForm = $usuarioEditando ? 'atualizar&id=' . $usuarioEditando['id'] : 'cadastrar';
        ?>

        <form method="POST" action="index.php?acao=<?= $acaoForm ?>">
            <div>
                ...
                <?php foreach ($usuarios as $usuario): ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="btn btn-apagar" href="index.php?acao=excluir&id=<?= $usuario['id'] ?>" onclick="return confirm('Apagar este usuário?')">Apagar</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
